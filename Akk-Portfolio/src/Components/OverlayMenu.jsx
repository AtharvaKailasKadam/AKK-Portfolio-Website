            ...
            <AnimatePresence>
                {
                    ...
                    isOpen && (
                        ...
                        >
                            ...
                            <ul className="space-y-6 text-center font-semibold tracking-widest text-white hover:cursor-pointer transition-colors duration-300">
                                {[
                                    "Home",
                                    "About",
                                    "Skills",
                                    ...
                                    <motion.li key={item} initial = {{opacity:0, y:20}} animate = {{opacity:1, y:0}} transition = {{delay:0 + index * 0.1}} whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.95 }}>
                                        <a
                                            ...
                                            onClick={onClose}
                                            className="text-white text-4xl hover:text-pink-300 transition-colors duration-300"
                                        >
                                            {item}
                                        </a>
                                    </motion.li>
