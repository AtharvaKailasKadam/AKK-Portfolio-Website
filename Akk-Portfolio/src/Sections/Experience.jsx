...
function ExperienceItem({ idx, start, end, role, company, duration, description, layout, scrollYProgress}) {
                        ...
                        <div className="flex flex-1 items-center justify-center px-6 pb-10">
                            ...
                            {isMobile && (
                                <div className="relative w-full max-w-md">
                                    <div className="relative left-0 top-0 h-[6px] bg-white/15 rounded">
